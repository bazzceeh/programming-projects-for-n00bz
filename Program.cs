...
namespace RollProgram
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            do
            {
                int i = roll.Next(0, 100);
                Console.Clear();
                Console.SetCursorPosition(0, 0);
                Console.WriteLine("You rolled {0}, Which means your challenge is: {1}", i, Challenges[i]);
                Console.WriteLine("Press enter to reroll, any other key to exit");
            }
